...
import { addProductCartApi, fetchCartApi, removeProductFromCartApi, selectAllProductApi, selectProductApi, updateProductInCartApi } from "../api/cartApi";
        ...
        (set, get) => ({
            ...
            updateProductQuantity: async ({ cartId, quantity }) => {
                try {
                    ...
                    await updateProductInCartApi(cartId, { quantity })
                } catch (error) {
                    console.log(error)
                }
            },
